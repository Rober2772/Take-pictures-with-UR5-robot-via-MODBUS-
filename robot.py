...
client = ModbusClient(host=ip_robot, port=502, unit_id=255,auto_open=True, auto_close=True)
...
while True:
    ...
    if accion=="d":
        ...
        print("Posición de inicio")
            ...
            carpetas_existentes = [d for d in os.listdir(base_path) if os.path.isdir(os.path.join(base_path, d))]
            ids_encontrados = []
            ...
            with open(nombre_archivo, mode='w', newline='') as file:
                ...
                writer.writerow(["Fecha", "Hora", "Ángulo", "Dirección", "Subtrayectoria", "Mov X", "Mov Y", "Posición"])
                        ...
                        if reg_angulo and reg_movx and reg_movy and reg_activar:
                            ...
                            if angulo_val in lista_angulos:
                                if clave_foto != ultimo_angulo_foto:
                                    ...
                                    print(f"FOTO: Subtrayectoria {fase:>2} | Ang {angulo_val:>2} |")
